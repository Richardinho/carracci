...
Glenmorangie.ConnectorFactory = (function () {
    ...
    Connector = function ( baseX, baseY) {
        var nodes = [],
            lines = [],
            lineMode = "normal";
        ...
        return ({
            ...
            _createNode : function (x, y, id) {
                ...
                var node = Glenmorangie.nodeFactory.createNode(this, x, y, id);
                nodes.push(node);
                return node;
            },
            ...
            _createNodeWithArrow : function (x, y, id, partnerNode, distalNode) {
                ...
                var node = Glenmorangie.nodeFactory.createNodeWithArrow(this, x, y, id, partnerNode, distalNode);
                nodes.push(node);
                return node;
            },
