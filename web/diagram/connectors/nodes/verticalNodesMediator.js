define([
  ...
  return AbstractNodeMediator.extend({
    ...
    destroy: function() {
      this.detachAll()
      this.topArrowModel.trigger('destroy')
      this.secondTopNodeModel.trigger('destroy')
      this.secondBottomNodeModel.trigger('destroy')
      this.bottomArrowModel.trigger('destroy')
    },
    ...
    removeBoxNodeMediator: function(orientation) {
      ...
      if (orientation === 'top') {
        ...
        this.bottomArrowModel.model['attachedBox'] = null
    ...
    _attachTypeBoxToBottomNode: function(boxNodeMediator) {
      ...
      this.bottomArrowModel.model['attachedBox'] = box
    ...
    _attachTypeBoxToTopNode: function(boxNodeMediator) {
      ...
      var box = boxNodeMediator.typeController.model.model.id
      this.topArrowModel.model['attachedBox'] = box
      ...
      switch (orientation) {
        ...
        case 'bottom':
          ...
          this.bottomArrowModel.setYCood(
            this.bottomNodeTypeBoxMediator.calculateNodeYCood(
              secondBottomNodeYCood
            )
          )
    ...
    updateTopArrow: function(x, y, overRideConstraints) {
      if (this._topArrowAttached()) {
        ...
        if (!overRideConstraints) {
          var coods = this.topNodeTypeBoxMediator.getTopNodeCoods(
            x,
            y,
            currentX,
            currentY
    ...
    updateSecondTopNode: function(x, y) {
      ...
      if (this._topArrowAttached()) {
        ...
        var coods = this.topNodeTypeBoxMediator.getSecondTopNodeCoods(
          x,
          y,
          currentX,
          currentY
    ...
    updateSecondBottomNode: function(x, y) {
      if (this._bottomArrowAttached()) {
        ...
        // ask mediator if we can move this node
        var coods = this.bottomNodeTypeBoxMediator.getSecondBottomNodeCoods(
          x,
          y,
          currentX,
          currentY
    ...
    updateBottomArrow: function(x, y, overRideConstraints) {
      if (this._bottomArrowAttached()) {
        ...
        if (!overRideConstraints) {
          ...
          var coods = this.bottomNodeTypeBoxMediator.getBottomNodeCoods(
            x,
            y,
            currentX,
            currentY
    ...
    _setBottomArrowDirection: function() {
      if (
        this.bottomArrowModel.getYCood() < this.secondBottomNodeModel.getYCood()
      ) {
    ...
    _setTopArrowDirection: function() {
      if (this.topArrowModel.getYCood() < this.secondTopNodeModel.getYCood()) {
